...
<modules>
  <module version="1.0.0">com.example.tiyoutubeplayer</module>
</modules>
...
```js
import MyModule from 'com.example.tiyoutubeplayer';
MyModule.foo();
```
...
```js
var MyModule = require('com.example.tiyoutubeplayer');
MyModule.foo();
```
